...
while ($f = mysqli_fetch_array($select)) {
	...
	$user_id = $f['user_id'];
	;?>
	<div style="position: absolute;margin: auto;top: 0;bottom: 0;right: 0;left: 0;width: 50%;height: 70vh;background-color: white;border-radius: 10px;">
		<img src=".<?php echo $path ;?>" style="width:670px;height: 447px;border-radius: 5px;margin-top: 5px;margin-left: 5px;">
	</div>
	<div class="can" >
		<i class="fas fa-times" style="margin-top: 5px;margin-left: 8px; color: gray;" id="hy" ></i>
	</div>
	<div class="set">
