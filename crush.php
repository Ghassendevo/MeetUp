...
<body style="background-color: "><div id="all">
		...
		<div class="header" style="border-top: 2px solid #1697ea;;">
			<br>
			<div class="loge">
				<h1 style="font-weight: 600;">MeetUp<i class="fas fa-child" style="color: #1697ea"></i></h1>
			</div>
		...
		<div class="ppo" >
				...
				<div style="width: 80%;margin-left: auto;margin-right: auto;height: 30px;" onclick="username()">
					<label style="color: gray;font-weight: 400;margin-left: 10px;display: none;" id="fir_us">Username</label>
						<div style="width: 100%;border-bottom:1px solid gray;display: flex;padding-bottom: 5px;cursor: text;" id="for_us">
							...
							<input type="text" name="username" class="f_username" required="" placeholder="Username" style="color: gray;border:none; font-weight: 400;margin-left: 10px;cursor: text;width: 100%;" id="fi_us">
				...
				<div style="width: 80%;margin-left: auto;margin-right: auto;height: 30px;" onclick="password()">
					<label style="color: gray;font-weight: 400;margin-left: 10px;display: none;" id="fir_us">Password</label>
						<div style="width: 100%;border-bottom:1px solid gray;display: flex;padding-bottom: 5px;cursor: text;" id="po_us">
							...
							<input type="text" required="" class="f_password" name="password" placeholder="Password" style="color: gray;border:none; font-weight: 400;margin-left: 10px;cursor: text;width: 100%;" id="pi_us">
			...
			<div class="show" style="display: none;" >
					...
					<div style="width: 90%;margin: auto;margin-top: 10px;">
						<div class="form-outline">
						  <input onkeypress="return runScript(event)" type="password" id="form1" class="form-control password" placeholder="Password" />
						</div>
...
<div id="jj" style="position: absolute;top: 0;bottom: 0;left: 0;right: 0;margin: auto;background: rgba(0, 0, 0, 0.6);">
		<div class="cant" style="">
			<div style="width: 90%;margin: auto;text-align: center;margin-top: 20px;">
				<a style="font-weight: 400;font-size: 25px;color: red;">Can't Find Account</a>
				<p style="color: gray;margin-top: 10px;text-align: left;">It looks the information you had entered dosn't match an existing account. If you don't have a Meetup account, you can create one now.</p>

				<div class="af" >
					<a style="" id="c_new" class="c_ac">CREATE ACCOUNT</a><a id="again" style="color: #1697ea;" class="c_ac">TRY AGAIN</a>
				</div>
			</div>
		</div>
	</div>
